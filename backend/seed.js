  ...
  const posts = [
    {
      ...
      image: { url: 'https://images.unsplash.com/photo-1523531294919-4bcd7c65e216?w=800', alt: 'Tuscany landscape' },
    ...
    },
    {
      ...
      image: { url: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=800', alt: 'React coding' },
    ...
    },
    {
      ...
      image: { url: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=800', alt: 'Fresh pasta' },
    ...
    },
    {
      ...
      author: admin._id,
      category: categories[0]._id,
      image: { url: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?w=800', alt: 'Tokyo skyline' },
    ...
    },
    {
      ...
      author: author._id,
      category: categories[1]._id,
      image: { url: 'https://images.unsplash.com/photo-1507721999472-8ed4421c4af2?w=800', alt: 'CSS coding' },
    ...
    },
    {
      ...
      author: admin._id,
      category: categories[2]._id,
      image: { url: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=800', alt: 'Sourdough bread' },
